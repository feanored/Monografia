...
Esta é a primeira rede neural artificial a ser criada, e também a mais simples. Dá-se o nome de \eng{perceptron} de camada única (\eng{single-layer perceptron}), e uma ilustração conceitual dele está na Figura ~\ref{fig:perceptron}. Mais recentemente foram criadas várias outras versões dessa rede, dentre as quais podemos citar o \eng{perceptron} de multi-camadas (\eng{multi-layer perceptron}). 
