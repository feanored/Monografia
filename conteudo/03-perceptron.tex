...
\section{Keras - Uma API de redes neurais para \eng{deep learning}}

De acordo com seu site oficial\footnote{\url{https://keras.io/about/}}, \eng{Keras} é uma API (Interface de Programação de Aplicativos) de \eng{deep learning} escrita em Python, e que roda sobre a plataforma de \eng{machine learning} chamada de \eng{TensorFlow}\footnote{\url{https://github.com/tensorflow/tensorflow}} que é de fato a biblioteca que devemos instalar em nosso ambiente Python, para podermos utilizar as redes neurais ali implementadas e quaisquer outros recursos da API \eng{Keras} em nosso projeto de aprendizado.
