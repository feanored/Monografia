...
\orientador[masc]{Prof. Dr. José Coelho de Pina Junior}
...
\banca{
  \begin{itemize}
    \item Prof. Dr. José Coelho de Pina Junior (orientador) -- IME-USP [sem ponto final]
...
\bancaeng{
  \begin{itemize}
    \item Prof. Dr. José Coelho de Pina Junior (advisor)  -- IME-USP [sem ponto final]
    \item Prof. Dr. Nome Completo -- IME-USP [sem ponto final]
    \item Prof. Dr. Nome Completo -- IMPA [sem ponto final]
  \end{itemize}
}
