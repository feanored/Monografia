...
\banca{
  \begin{itemize}
    \item José Coelho de Pina Junior (orientador) -- IME-USP [sem ponto final]
...
\bancaeng{
  \begin{itemize}
    \item José Coelho de Pina Junior (advisor)  -- IME-USP [sem ponto final]
    \item Nome Completo -- IME-USP [sem ponto final]
    \item Nome Completo -- IMPA [sem ponto final]
  \end{itemize}
}
...
\palavraschave{redes-neurais. perceptron.}
